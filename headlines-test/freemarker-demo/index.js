...
new Vue({
    el: '#app', data() {
        return {
            // Minio模板应该写真实接口地址
            baseUrl: 'http://localhost:51601', //'http://172.16.17.191:5001',
            token: '',
            equipmentId: '',
            articleId: '',
            title: '',
            ...
            publishTime: '',
            relation: {
                islike: false, isunlike: false, iscollection: false, isfollow: false, isforward: false
            },
            followLoading: false,
            likeLoading: false,
            unlikeLoading: false,
            collectionLoading: false, // 评论
            comments: [],
            commentsLoading: false,
            commentsFinished: false,
            commentValue: '',
            currentCommentId: '', // 评论回复
            commentReplies: [],
    ...
    methods: {
        ...
        async handleClickArticleUnlike() {
            ...
            const data = {
                equipmentId: this.equipmentId, articleId: this.articleId, type: this.relation.isunlike ? 1 : 0
            }
            const config = {headers: {'token': this.token}}
